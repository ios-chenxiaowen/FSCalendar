...
- (void)loadView
{
    ...
    calendar.appearance.titleDefaultColor = [UIColor greenColor];
    calendar.appearance.headerTitleColor = [UIColor blueColor];
...
//    NSDate * date = [NSDate dateWithTimeIntervalSince1970:1646125794];
//    NSDate * date1 = [self.gregorian fs_firstDayOfMonth:date];
//    NSDate * date2 = [self.gregorian fs_lastDayOfMonth:date];
//    NSDate * date3 = [self.gregorian fs_firstDayOfWeek:date];
//    NSDate * date4 = [self.gregorian fs_lastDayOfWeek:date];
//    NSDate * date5 = [self.gregorian fs_middleDayOfWeek:date];
//
//    NSString * str =  [self.dateFormatter stringFromDate:date];
//    NSString * str1 =  [self.dateFormatter stringFromDate:date1];
//    NSString * str2 =  [self.dateFormatter stringFromDate:date2];
//    NSString * str3 =  [self.dateFormatter stringFromDate:date3];
//    NSString * str4 =  [self.dateFormatter stringFromDate:date4];
//    NSString * str5 =  [self.dateFormatter stringFromDate:date5];
//
//
//
//    NSInteger month = [self.gregorian fs_numberOfDaysInMonth:date];
//
//    NSLog(@"%d",month);
}
